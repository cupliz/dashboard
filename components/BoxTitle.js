        ...
        <div className="card-body row pr-4">
          ...
          <div className="col p-0 m-0 bg-transparent mr-auto mb-2 mt-2">
            ...
            <div className="row m-0 col bg-transparent">
                <img src="../static/img/social/facebook.png" className="img m-1"/>
                <img src="../static/img/social/twitter.png" className="img m-1"/>
                <img src="../static/img/social/instagram.jpg" className="img m-1"/>
                <img src="../static/img/social/linkedin.png" className="img m-1"/>
            </div>
          </div>
